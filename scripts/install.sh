...
echo ""
echo "Next steps:"
echo "1. Restart your MCP-compatible client(s) — Claude Desktop, Claude Code,"
echo "   Codex, Gemini (Antigravity), Cursor, etc. (any that were configured above)"
echo "2. Confirm the 'amiberry' MCP server appears in your client's tool list"
echo "3. Try asking: 'What Amiberry configurations do I have?'"
echo ""
echo "Claude Desktop config file: $CONFIG_FILE"
