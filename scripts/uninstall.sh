...
echo "2. Remove the amiberry entry from each detected MCP client config"
echo "   (Claude Desktop, Claude Code, Codex, Gemini/Antigravity)"
...
echo ""
echo "Remember to restart any MCP client that had Amiberry configured!"
